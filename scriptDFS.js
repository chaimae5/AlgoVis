...
async function runDFS() {
    ...
    // Note: To mimic true recursive DFS order with a stack, 
    // children should be pushed in reverse order.
...
document.getElementById("executeButton").addEventListener("click", runDFS);
